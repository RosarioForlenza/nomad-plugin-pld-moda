...
```sh
git clone https://github.com/RosarioForlenza/nomad-plugin-pld-moda.git
cd nomad-plugin-pld-moda
...
```sh
pip install dist/nomad-plugin-pld-moda-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| Rosario Forlenza | [rforlenz@sissa.it](mailto:rforlenz@sissa.it)
